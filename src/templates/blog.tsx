                ...
                <>
                  <a
                    ...
                    href={
                      ...
                      encodeURIComponent(
                        `${data.markdownRemark.frontmatter.title} by ${authors
                          .map((author) => '@' + author.socialProfiles.twitter)
                          .join(', ')} ${data.site.siteMetadata.siteUrl + data.markdownRemark.fields.slug}`
                      )
                    }
                    target="_blank"
                  >
                  ...
                  <a
                    ...
                    )}&title=${encodeURIComponent(data.markdownRemark.frontmatter.title)}`}
                    target="_blank"
                  >
